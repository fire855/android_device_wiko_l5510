...
#define USE_ARRAY_INSTEAD_OF_MALLOC
...
#ifdef USE_ARRAY_INSTEAD_OF_MALLOC
static int32 doep_var_buf[300];
#endif
...
#ifndef AKMD_DISABLE_DOEPLUS
#ifndef USE_ARRAY_INSTEAD_OF_MALLOC
